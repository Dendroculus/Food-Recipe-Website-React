export const dairyfreerecipes = [
{
  ...
  instructions: [
    ...
    "Heat 1/4 cup (60 ml) olive oil in a large nonstick skillet over medium-high heat. Add the cubed eggplant and cook, stirring occasionally, until golden brown and tender, about 10 minutes (it will shrink quite a bit). Using a slotted spoon, remove the eggplant and set it aside on a plate.",
  ...
  videoUrl: "https://www.youtube.com/embed/1-tpTqROCEc?si=80yrfkpeQ6nVL-f_"
},
{
  ...
  videoUrl: "https://www.youtube.com/embed/LPPcNPdq_j4?si=3G8OaT4EaVR_13W2"
},
{
  id: "peanut-noodle",
  ...
  videoUrl: "https://www.youtube.com/embed/kkGx5_wWAdU?si=R0px526f6kVawVMS"
},
{
  id: "potstickers",
  name: "Potstickers",
  ...
  instructions: [
    "Place the mushrooms in a bowl and pour over plenty of boiled water. Leave for 20 minutes or until rehydrated. Squeeze out excess water, then finely chop.",
    "Place cabbage in a bowl with salt. Toss with fingers, then set aside for 15 minutes. Squeeze out excess liquid from cabbage using hands.",
    "Place cabbage, mushrooms and remaining Filling ingredients in a bowl. Mix with your hands until well combined.",
    ...
    "Heat 2 teaspoon oil in a non stick pan over medium high heat. Add dumplings, pressing down firmly to flatten the base onto the pan. Cook around 8 to 10 per batch.",
  ...
  videoUrl: "https://www.youtube.com/embed/iC1rvXPt_rE?si=67k2FvdAwgXnm7Nb"
},
{
  id: "rendang",
  name: "Rendang Beef",
  ...
  videoUrl: "https://www.youtube.com/embed/iS8YyFUyP90?si=h5j5JKjCSPxTI9lE"
},
{
  id: "lemon-chicken",
  name: "Sesame Lemon Chicken",
  prepTime: "10 mins",
  cookTime: "15 mins",
  totalTime: "25 mins",
  difficulty: "Easy",
  ...
  videoUrl: "https://www.youtube.com/embed/U_eWmsTawyU?si=kjgjdeK0JtbrXo-1"
},
{
  id: "southwestern-goulash",
  name: "Southwestern Goulash",
  prepTime: "10 mins",
  cookTime: "15 mins",
  totalTime: "25 mins",
  difficulty: "Easy",
  ...
  videoUrl: "https://www.youtube.com/embed/sOTxFWMlc9M?si=eHZ-1hS-ATHQxQuM"
},
{
  id: "turkey-pie",
  name: "Turkey Pot Pie",
  ...
  videoUrl: "https://www.youtube.com/embed/508vtSy1p64?si=8IZ1GOWPJ3T06WR_"
}
];
...
export const glutenFreeRecipes = [
  {
    id: "root-vegetables",
    name: "Air-fried Root Vegetables",
    prepTime: "15 mins",
    cookTime: "20 mins",
    totalTime: "35 mins",
    difficulty: "Easy",
  ...
  },
  {
    ...
    instructions: [
      ...
      "Increase heat slightly to medium high. Cook for 4 minutes, whisking regularly, until the sauce thickens to the consistency of thick syrup. Remove from stove.",
      "Drizzle 1 tbsp oil over chicken, mix to coat. Sprinkle with Seasoning, toss to coat.",
      "Heat remaining 1 tbsp oil in a large skillet over high heat. Add chicken, cook 2 minutes. Turn and cook 1.5 minutes. Remove, rest 2 minutes then chop.",
  ...
  },
  {
    ...
    instructions: [
      "Pour the yogurt into a large bowl. Stir in the salt.",
      ...
      "Spread the labneh in a bowl and top with extra virgin olive oil, za'atar spice (or chopped fresh herbs like mint or parsley). Add warm pita and fresh veggies for dipping."
    ],
    nutrition: {
      calories: 74.7,
      carbs: "5.7g",
  ...
  },
  {
    ...
    instructions: [
      ...
      "To make the sauce, heat a wok or small saucepan to medium high heat, and add 2 tablespoons vegetable oil. Add the remaining 2/3 of the ginger, and fry for 1 minute. Add the white parts of the scallions and cook for 30 seconds.Then add rest of the scallions and cilantro. The mixture should be sizzling.",
...
export const veganRecipes = [
  {
    ...
    youtubeId: "3ZG1-o2aqeU"
  },
  {
    id: "carrot-turmeric-soup",
    name: "Carrot Turmeric Soup",
    prepTime: "5 mins",
    cookTime: "55 mins",
    totalTime: "1 hr",
    difficulty: "Easy",
  ...
  },
  {
    ...
    instructions: [
      ...
      "Remove onto paper towel lined plate to drain. Then roll in sugar. Serve hot with Chocolate Sauce (Place in a heatproof bowl and microwave in 30 second bursts, stirring in between, until smooth. Set aside for 5 minutes to cool and thicken slightly.)!"
    ],
    nutrition: {
      calories: 189,
      carbs: "22g",
  ...
  },
  {
    ...
    instructions: [
      "Preheat the oven to 400ºF. Line a baking sheet or 9x13-inch baking dish with aluminum foil. Scrub your potatoes under running water, then pat them dry with paper towels.",
      ...
      "Bake the potatoes until their skins are very crisp and they're fluffy on the inside and easily pierced through with a knife, 1 1/2 to 2 hours. Don't be afraid to leave them in the oven for the full 2 hours, especially if they're on the bigger side.",
    ...
    youtubeId: "T79dEQbYCKU"
  },
  {
    id: "miso-risotto",
    name: "Mushroom Miso Risotto",
    prepTime: "15 mins",
    cookTime: "30 mins",
    totalTime: "45 mins",
    difficulty: "Easy",
    ...
    instructions: [
      "Soak the shiitake mushrooms in boiling water for 20 minutes. Then remove the mushrooms, squeeze out the water from the mushrooms. In a medium saucepan over medium heat, add the mushroom broth, dashi broth and miso paste and mix until combined. Bring to a low simmer then cover remove from heat to keep warm.",
      "In a large deep skillet, melt the butter over medium heat. Add the mushrooms, salt, and pepper and toss to coat. Cook the mushrooms undisturbed for a few minutes to develop browning. Cook for 8 minutes or until browned and softened stirring occasionally. Remove and set aside.",
      "In the same pan, add 2 tablespoons of olive oil over medium heat until hot. Then add the shallots and garlic and cook until the shallots are translucent about 2 minutes. Add the rice and toss until everything is coated and the rice is slightly toasted about 1 minute. Next, add the sake, stir, and cook until it cooks down, about 3 minutes.",
  ...
  },
  {
    ...
    instructions: [
      ...
      "Pair your waffles with fresh blueberries, strawberries, raspberries or blackberries, and top with pure maple syrup. You may even like to drizzle with vegan chocolate syrup and add a dollop of whipped coconut cream. (Makes 4 – 5 waffles.)",
...
export const vegetarianRecipes = [
  ...
  },
  {
    ...
    instructions: [
      "Gather all ingredients.",
      "Preheat the oven to 400 degrees F (200 degrees C). Line a baking sheet with parchment paper. Lay cauliflower steaks on the prepared baking sheet.",
      ...
      "Roast cauliflower steaks in the preheated oven for 15 minutes. Flip and brush tops with remaining olive oil mixture.",
      "Serve and enjoy!"
    ],
    nutrition: {
      calories: 176,
  ...
  },
  {
    ...
    instructions: [
      ...
      "Blend the tomatoes in a blender. Strain tomatoes into a bowl. Alternatively, use canned tomato passata. Mince the garlic cloves.",
    ...
    youtubeId: "63kLwr61dEk"
  },
  {
    id: "pea-and-mint-soup",
    ...
    instructions: [
      ...
      "Serve your Pea and Mint Soup with a slice of crusty bread and a swirl of creme fraiche on the top. For a non-vegan version, a topping of grilled bacon tastes incredible."
    ],
    nutrition: {
      calories: 194,
      carbs: "32g",
  ...
  },
  {
    ...
    instructions: [
      "Place eggplant in a colander set over a bowl. Sprinkle with salt, toss with hands. Leave for 30 minutes to sweat (no need to wipe off water that beads on surface).",
      "Place tomato in a blender, food processor or other appliance of choice. Blitz until smooth. (No need to do this if using passata or crushed tomato.)",
      "Heat 2 tablespoon of oil in a large skillet over medium high heat. Add eggplant and cook for 4 to 5 minutes, stirring regularly, until it's golden on the surface but still somewhat firm and raw inside. Transfer to a large pot.",
      "In the same skillet, add another 1 tablespoon olive oil. Add onion and garlic with a pinch of the salt. Cook for 3 minutes until onion is soft with a hint of golden on the edges. Add to pot holding eggplant.",
      "Add another 1 tablespoon of olive oil and cook the capsicum with a pinch of salt for 3 minutes. It should still be firm inside. You won't get much colour on the capsicum. Add to pot.",
      "Add another 1 tablespoon olive oil and cook the zucchini with a pinch of salt for 3 minutes. Make sure it stays firm (ie. raw inside). Like the capsicum, it won't go golden. Add to pot.",
      "Turn the stove under the pot to medium-high. Add tomato, thyme, olives, remaining salt and all the pepper, and mix. Once the mixture is hot, reduce heat to a low simmer.",
      "Cook for 20 – 25 minutes with the pot lid off, stirring every now and then, until all the vegetables are cooked through and the liquid has reduced. The mixture should be thick enough so you can pile it on a plate (ie. not watery), but still very moist and juicy.",
      "Taste and add more salt if needed; vegetables can taste bland if not enough salt is added. Stir through basil then serve immediately, drizzled with extra virgin olive oil and a sprinkle of extra basil on top, if desired. Serve as a main with crusty bread, or as a side dish."
    ],
    nutrition: {
      calories: 158,
      carbs: "11g",
    ...
    youtubeId: "b3H1utLhVBM"
  },
  {
    id: "sauteed-fiddleheads",
    name: "Sauteed Fiddleheads",
    prepTime: "15 mins",
    grillTime: "15 mins",
    totalTime: "30 mins",
    difficulty: "Easy",
    ...
    instructions: [
      ...
      "Heat olive oil in a large skillet over medium-high heat. Stir in prepared fiddlehead ferns, garlic, salt, and pepper.",
      "Cook and stir until ferns are lightly browned and tender, about 5 minutes. Remove from heat and sprinkle with lemon juice."
    ],
    nutrition: {
      calories: 80,
      carbs: "3g",
